...
**Companion:** `wiki/plan.md` is the master implementation plan — read it when the task involves architecture, rules, schema design, workflows, or success criteria changes.
...
| File | Purpose |
|---|---|
| `wiki/plan.md` | Master implementation plan — architecture, rules, workflows, success criteria |
| `schema/instructions.md` | This file — operational master guide for all agents |
...
1. **`schema/instructions.md`** — Always first. This file.
